...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_CAPS, KC_LCMD, KC_LALT, KC_LCTL, KC_LSFT,    MO(2),   KC_LBRC,      KC_RBRC, MO(2),      KC_RSFT,    KC_RCTL, KC_RALT,  KC_RCMD, TO(1)
  ),
  ...
  [1] = LAYOUT(
    ...
    KC_CAPS, KC_ESC,  KC_INS, KC_R, KC_SPC,  KC_9, KC_0,      KC_RBRC, MO(2),      KC_RSFT,    KC_RCTL, KC_RALT,  KC_RCMD, TO(0)
  ),
