...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    KC_CAPS,  KC_1,    KC_2,    KC_3,    KC_4, KC_5,                                          KC_6,  KC_7,  KC_8,    KC_9,    KC_0,    TO(1),
    ...
    KC_GRV, KC_LCMD, KC_LSFT, KC_LALT, MO(2),    KC_LCTL,   KC_LBRC,      KC_RBRC, KC_LCTL,        MO(2), KC_LALT, KC_LSFT, KC_LCMD, KC_NO
  ),

  [1] = LAYOUT(
    KC_0, KC_1,   KC_2,    KC_3,    KC_4, KC_5,                                          KC_P, KC_L,  KC_U,    KC_Y,    KC_F9,  TO(0),
    KC_9, KC_LSFT, KC_Q, KC_LSFT, KC_E, KC_T, KC_N,                        KC_EQL,  KC_J, KC_BTN1,    KC_WH_D,    KC_BTN2,     KC_WH_U,  KC_BSPC,
    KC_8,   KC_W,    KC_A, KC_S,    KC_D, KC_F, KC_G,                        KC_SLSH, KC_M, KC_MS_R,    KC_MS_D,    KC_MS_L,     KC_MS_U,    KC_ENT,
    KC_ESC,   KC_Z,    KC_X, KC_C,    KC_V, KC_B, KC_LALT, MO(3),      KC_NO, KC_NO, KC_K, KC_H,    KC_P, KC_I,  KC_O, KC_DEL,
    KC_GRV, KC_R,  KC_8, KC_7, KC_SPC,  KC_6, KC_LCTL,                KC_RBRC, KC_BTN2,   KC_BTN1, KC_LALT, KC_LSFT, KC_LCMD,KC_NO
  ),
  ...
  [2] = LAYOUT(
    ...
    KC_GRV,  KC_NO, KC_VOLD, KC_MUTE, KC_VOLU, KC_DEL, KC_NO, KC_NO,      KC_MSEL, KC_MAIL, KC_K,KC_VOLU,  KC_MUTE, KC_VOLD, KC_NO, KC_DEL,
  ...
  [3] = LAYOUT(
    ...
    KC_NO,  KC_SLSH, KC_DOT, KC_COMM, KC_M, KC_V, KC_NO, KC_NO,      KC_MSEL, KC_MAIL, KC_K,KC_VOLU,  KC_MUTE, KC_VOLD,KC_NO, KC_DEL,
