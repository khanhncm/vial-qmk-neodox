...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_CAPS, MO(2), KC_LALT, KC_LSFT, KC_LCTL,    KC_LCMD,   KC_LBRC,    KC_RBRC, KC_LCMD,     KC_LCTL, KC_LSFT, KC_LALT,  MO(2),   TO(1)
  ),
  ...
  [1] = LAYOUT(
    ...
    KC_CAPS, KC_ESC,  KC_INS, KC_R, KC_SPC,  KC_9, KC_0,      KC_RBRC, KC_LCMD,      KC_LCTL, KC_LSFT, KC_LALT,  MO(2), TO(0)
  ),

  [2] = LAYOUT(
    KC_ESC, KC_F1,    KC_F2,    KC_F3,    KC_F4, KC_F5,                                          KC_F6, KC_F7,    KC_F8,    KC_F9,     KC_F10,    KC_DEL,
    KC_TAB,    KC_NO, KC_VOLD,  KC_MUTE, KC_VOLU, KC_B, KC_F11,                        KC_F12,  KC_J, KC_PGDN,    KC_END,    KC_PGUP,     KC_HOME,  KC_BSPC,
    KC_SPC,    KC_MSEL, KC_MPRV, KC_MPLY, KC_MNXT, KC_G, KC_BSPC,                        KC_SLSH, KC_M, KC_RIGHT,    KC_DOWN,    KC_LEFT,     KC_UP,    KC_ENT,
    KC_GRV,    KC_CPNL,    KC_MAIL,    KC_MYCM, KC_WHOM, KC_V, KC_NO, QK_BOOT,      KC_MSEL, KC_MAIL, KC_K, KC_H,    KC_SCLN, KC_QUOT,  KC_COMM, KC_APP,
    KC_CAPS, KC_NO, KC_LALT, KC_LSFT, KC_LCTL,    KC_LCMD,   KC_LBRC,      KC_RBRC, KC_LCMD,      KC_LCTL, KC_LSFT, KC_LALT,  KC_NO,   TO(1)
  ),
