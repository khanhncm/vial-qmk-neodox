...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_GRV, KC_LCMD, KC_LSFT, KC_LALT, MO(2),    KC_LCTL,   KC_LBRC,      KC_RBRC, KC_LCTL,        MO(2), KC_LALT, KC_LSFT, KC_LCMD, TO(1)
  ),
  ...
  [1] = LAYOUT(
    ...
    KC_GRV, KC_R,  KC_8, KC_7, KC_SPC,  KC_6, KC_LCTL,                KC_RBRC, KC_BTN2,   KC_BTN1, KC_LALT, KC_LSFT, KC_LCMD, TO(0)
  ),
  ...
  [2] = LAYOUT(
    ...
    KC_GRV,  KC_NO, KC_VOLD, KC_MUTE, KC_VOLU, KC_DEL, TO(1), KC_NO,      KC_MSEL, KC_MAIL, KC_K,KC_VOLU,  KC_MUTE, KC_VOLD, KC_NO, KC_DEL,
  ...
  [3] = LAYOUT(
    ...
    KC_NO,  KC_SLSH, KC_DOT, KC_COMM, KC_M, KC_V, TO(0), KC_NO,      KC_MSEL, KC_MAIL, KC_K,KC_VOLU,  KC_MUTE, KC_VOLD,KC_NO, KC_DEL,
