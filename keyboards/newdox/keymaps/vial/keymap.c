...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    KC_F9,  KC_6,    KC_7,    KC_8,  KC_9, KC_BSPC, KC_F11,                        KC_F12,  KC_J, KC_KP_9,    KC_KP_8,    KC_KP_7,     KC_KP_PLUS,  KC_BSPC,
    KC_F8,  KC_UP, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT, KC_F12,                        KC_SLSH, KC_M, KC_KP_6,  KC_KP_5,    KC_KP_4,     KC_KP_DOT,    KC_ENT,
