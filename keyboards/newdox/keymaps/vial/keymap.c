...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    KC_F9,  KC_6,    KC_7,    KC_8,  KC_9, KC_BSPC, KC_F11,                        KC_F12,  KC_J, KC_PGDN,    KC_END,    KC_PGUP,     KC_HOME,  KC_BSPC,
    KC_F8,  KC_UP, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT, KC_F12,                        KC_SLSH, KC_M, KC_RIGHT,  KC_DOWN,    KC_LEFT,     KC_UP,    KC_ENT,
    KC_F7,  KC_0, KC_COMM, KC_DOT, KC_SLSH, KC_DEL, TO(2), TO(4),      KC_NO, KC_NO, KC_K,KC_VOLU,  KC_MUTE, KC_VOLD, KC_NO, KC_DEL,
    KC_F6, KC_LCMD, KC_LSFT, KC_LALT, KC_NO,    KC_LCTL,   KC_LBRC,            KC_RBRC, KC_LCTL,       KC_NO, KC_LALT, KC_LSFT, KC_LCMD,   KC_NO
  ),

  [2] = LAYOUT(
    KC_ESC, KC_1,  KC_2, KC_3,    KC_4,   KC_5,                                          KC_P, KC_L,  KC_U,    KC_Y,    KC_F9,  TO(0),
    KC_8,   KC_LSFT, KC_E, KC_LSFT, KC_E,   KC_R,    KC_T,                        KC_EQL,  KC_J, KC_BTN1,    KC_WH_D,    KC_BTN2,     KC_WH_U,  KC_BSPC,
    KC_7,   KC_W,    KC_A, KC_S,    KC_D,   KC_F,    KC_G,                        KC_SLSH, KC_M, KC_MS_R,    KC_MS_D,    KC_MS_L,     KC_MS_U,    KC_ENT,
    KC_6,   KC_Q,    KC_X, KC_C,    KC_V,   KC_B,    KC_PSCR, MO(3),      KC_NO, KC_NO, KC_K, KC_H,    KC_P, KC_I,  KC_O, KC_DEL,
  ...
  [4] = LAYOUT(
    ...
    KC_TAB, KC_9,    KC_0, KC_G,    KC_SPC, KC_N, KC_END,                KC_RBRC, KC_BTN2,   KC_BTN1, KC_LALT, KC_LSFT, KC_LCMD, KC_NO
  ),
